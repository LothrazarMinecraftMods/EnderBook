...
public class GuiButtonTeleport extends GuiButton
{
	...
	public GuiButtonTeleport(int id, int x, int y,	int w, int h, String txt, int slot) 
	{
    ...
    public boolean mousePressed(Minecraft mc, int mouseX, int mouseY)
    {
    	...
    	if(pressed)
    	{
			...
			//but even if they dont, send packet anyway. server side has the real source of truth
